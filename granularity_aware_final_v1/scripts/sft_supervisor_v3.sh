...
LOG=$ROOT/runs/granularity_aware_final_v1/logs/sft_supervisor_v3.log
...
log "=== sft_supervisor_v3 starting (expandable_segments fix baked in) ==="

# qwen/full/weighted_none smoke already validated manually with the fix; go straight to main.
run_combo qwen full weighted_none yes
...
log "=== sft_supervisor_v3 finished remaining combos ==="
